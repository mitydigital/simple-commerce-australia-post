...
> Australia Post Shipping Methods is an addon for Statamic 3.3+ and Simple Commerce 3.1+ that provides a way to
> integrate with the Australia Post Postage Assessment Calculator.
...
itself with a $0.00 value may be a better approach. Otherwise you need to update this field in each Product. But this
